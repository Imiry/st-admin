...
<template>
  <div class="login_container">
    ...
    <div
      ...
      ref="lg_content"
      v-bind:style="{
        backgroundImage: 'url(' + bgImages[defaultindex].src + ')',
      }"
    >
      <!-- 登录区域 -->
        ...
        >
          <el-form-item prop="email" class="iput_con">
            <el-input
              ...
              prefix-icon=" icon iconfont icon-youxiang1"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item prop="agree" class="xieyi">
            <el-checkbox v-model="userLogin.agree" style="color: #fff"
          ...
          <el-form-item class="btn">
            <el-button
              ...
              >登录</el-button
            >
            <el-button class="zhuce" type="info" @click="register"
              >注册</el-button
            >
          </el-form-item>
        </el-form>
        ...
        >
          ...
          <el-form-item prop="name" class="iput_con">
            <el-input
              ...
              prefix-icon=" icon iconfont icon-yidongduanicon-"
            ></el-input>
          </el-form-item>
          <el-form-item prop="password" class="iput_psd">
            <ux-password
          ...
          <el-form-item prop="confirmPassword" class="iput_psd">
            <el-input
              ...
              prefix-icon=" icon iconfont icon-querenmima"
            ></el-input>
          </el-form-item>
          <el-form-item class="btn">
            <el-button
            ...
            <el-button
              class="zhuce"
              type="info"
              @click="cancleRrgister('registerFormRef')"
...
import { checkStrong, pwdLength610 } from "../../utils/mUtils";
